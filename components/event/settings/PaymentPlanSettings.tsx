  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border rounded-md p-6">
        ...
        <div className="rounded-md border border-primary-200 bg-[#009A44]/3 p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {(
              Object.entries(PLATFORM_FEES) as [
                TransactionType,
                typeof PLATFORM_FEES.vote,
              ][]
            ).map(([type, config]) => (
              <div
                key={type}
          ...
          <div className="mt-4 flex items-center gap-2 text-xs text-muted-foreground">
            ...
            Payouts settle {CASHOUT_CONFIG.settlementLabel.toLowerCase()} via
            your payout account
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border rounded-md p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            {(["vote", "nomination", "ticket"] as TransactionType[]).map(
              (type) => (
                <Button
      ...
      <div className="bg-card border rounded-md p-6">
        ...
        <p className="text-xs text-muted-foreground mb-4">
          Credits are used for SMS and WhatsApp notifications. Email and in-app
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="rounded-lg bg-muted/50 p-3 text-center">
            ...
            <p className="text-sm font-bold mt-0.5 text-[#009A44]">Free</p>
          </div>
        </div>
