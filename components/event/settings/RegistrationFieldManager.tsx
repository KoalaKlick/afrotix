                ...
                <div className="flex items-center justify-between p-3 border rounded-lg bg-muted/20 opacity-80">
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground uppercase font-medium">
                      System Required • Text
                    </p>
                  </div>
                  <Badge
                    variant="outline"
                    className="text-[9px] uppercase font-bold tracking-tighter h-5"
                  >
                    Core
                  </Badge>
                </div>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This will remove the field &quot;{field.label}
            ...
            <div className="space-y-4">
              ...
              {form.type === "select" && (
                <div className="space-y-2 animate-in slide-in-from-top-1">
                  <Label htmlFor="reg-field-options">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/30">
                ...
                <Switch
                  ...
                  onCheckedChange={(val) =>
                    setForm((prev) => ({ ...prev, isRequired: val }))
                  }
                />
              </div>
            </div>
