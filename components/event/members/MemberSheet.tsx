...
import { Loader2, Mail, Phone, User, ClipboardCheck, Hash } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="shrink-0">
          ...
          <SheetDescription>
            {editingMember
              ? "Update member details and custom responses"
              : "Manually add a new member to this event"}
          </SheetDescription>
        </SheetHeader>
        ...
        <SheetBody className="space-y-6 flex-1 overflow-y-auto pr-2 py-4">
          <div className="space-y-4">
            <div className="space-y-2">
              <Label
                htmlFor="member-name"
                className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-muted-foreground"
              >
                      ...
                      {field.type === "select" ? (
                        <Select
                          ...
                          onValueChange={(val) =>
                            setForm((prev) => ({
                              ...prev,
                              responses: { ...prev.responses, [field.id]: val },
                            }))
                          }
                        >
