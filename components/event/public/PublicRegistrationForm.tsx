  ...
  return (
    <div className={cn("", className)}>
      ...
      >
        ...
        <SheetContent
          side="right"
          className="sm:max-w-md w-full space-y-0  p-0 flex flex-col h-full border-l-0 sm:border-l"
        >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 flex flex-col justify-center">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground text-sm">
                  You're all set for <strong>{eventName}</strong>. Your unique
                  access code has been generated.
                </p>
              </div>
            ...
            <>
              <SheetHeader className="p-6 text-left border-b bg-muted/20">
                ...
                <SheetDescription className="text-xs">
                  Please fill in your details below to complete your
                ...
                >
                  ...
                  {registrationFields.length > 0 && (
                    <div className="pt-4 space-y-6 border-t border-dashed">
                      <p className="font-semibold text-base uppercase text-brand-primary">
              ...
              <SheetFooter className="p-6 bg-yellow-400 border-t bg-muted/20">
                <Button form="reg-form" type="submit" disabled={isPending}>
                  {isPending ? (
                    <>
