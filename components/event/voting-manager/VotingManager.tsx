...
export function VotingManager({
  ...
  function handleFieldUpdated(categoryId: string, updatedField: CustomField) {
    setCategories((prev) =>
      replaceFieldInCategory(prev, categoryId, updatedField),
    );
  }
  ...
  function handleApproveNomination(optionId: string) {
    startTransition(async () => {
      ...
      if (result.success) {
        setCategories((prev) =>
          updateOptionStatusInCategories(prev, optionId, "approved"),
        );
  ...
  function handleRejectNomination(optionId: string) {
    startTransition(async () => {
      ...
      if (result.success) {
        setCategories((prev) =>
          updateOptionStatusInCategories(prev, optionId, "rejected"),
        );
