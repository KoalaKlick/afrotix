            ...
            <div className="space-y-6 pb-4">
              <div className="flex items-center gap-4">
                <Avatar className="size-24 rounded-md">
                  <AvatarImage
                    src={
                      getEventImageUrl(selectedOption.option.imageUrl) ??
                      undefined
                    }
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <StatusBadge
                      variant={selectedOption.option.status}
                      size="sm"
                    />
                  </div>
              ...
              {selectedOption.category.customFields &&
                selectedOption.category.customFields.length > 0 &&
                selectedOption.option.fieldValues &&
                selectedOption.option.fieldValues.length > 0 && (
                  <div className="space-y-3">
                    <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider border-b pb-1">
                      Additional Information
                    </p>
                    <div className="space-y-3">
                      {selectedOption.category.customFields.map(
                        (field: any) => {
                          const val = selectedOption.option.fieldValues?.find(
                ...
                <div className="space-y-1">
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: selectedOption.option.description,
                    }}
                  />
                </div>
              )}
              {(selectedOption.option.nominatedByName ||
                ...
                <div className="space-y-2">
                  ...
                  <Card
                    variant="afro"
                    className=" border-0 shadow-xs p-2 w-fit"
                  >
