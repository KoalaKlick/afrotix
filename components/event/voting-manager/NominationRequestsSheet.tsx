  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        variant="afro"
        side="right"
        className="w-full sm:max-w-2xl px-3 flex flex-col h-full"
      >
                    ...
                    <TableRow key={option.id}>
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <Avatar className="size-8">
                            <AvatarImage
                              src={
                                getEventImageUrl(option.imageUrl) ?? undefined
                              }
                            />
                            <AvatarFallback>
                      ...
                      <TableCell>
                        <div className="flex flex-col text-xs text-muted-foreground">
                          ...
                          {option.nominatedByName && (
                            <span>By: {option.nominatedByName}</span>
                          )}
