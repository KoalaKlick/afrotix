...
export function replaceCategory(
  categories: VotingCategory[],
  updatedCategory: VotingCategory,
) {
...
export function replaceOptionInCategories(
  categories: VotingCategory[],
  updatedOption: VotingOption,
) {
  return categories.map((category) => ({
    ...category,
...
export function removeOptionFromCategories(
  categories: VotingCategory[],
  optionId: string,
) {
  return categories.map((category) => ({
    ...category,
    votingOptions: category.votingOptions.filter(
...
export function addFieldToCategory(
  categories: VotingCategory[],
  categoryId: string,
  field: CustomField,
) {
...
export function replaceFieldInCategory(
  categories: VotingCategory[],
  categoryId: string,
...
export function removeFieldFromCategory(
  categories: VotingCategory[],
  categoryId: string,
  fieldId: string,
) {
  return categories.map((category) => {
    ...
    return {
      ...category,
      customFields: category.customFields?.filter(
