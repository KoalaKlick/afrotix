...
import { Loader2, Upload, ImageIcon, Mail, Hash, FileText } from "lucide-react";
...
import { createOption, updateOption } from "@/lib/actions/voting";
...
export function OptionSheet({
  ...
  const { isUploading: isUploadingImage, upload: uploadNominee } =
    useImageUpload({
      bucket: "events",
      folder: "nominees",
      convertOptions: {
      ...
      setForm({
        ...
        fieldValues:
          category?.customFields?.map((field) => ({
            fieldId: field.id,
            value:
              editingOption.fieldValues?.find(
  ...
  const isDirty = useMemo(() => {
    ...
    return (
      form.optionText !== initialForm.optionText ||
      form.nomineeCode !== initialForm.nomineeCode ||
      form.email !== initialForm.email ||
      form.description !== initialForm.description ||
      form.imageUrl !== initialForm.imageUrl ||
      JSON.stringify(form.fieldValues) !==
        JSON.stringify(initialForm.fieldValues) ||
      pendingFile !== null
    );
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      ...
      let finalImageUrl: string | null | undefined =
        form.imageUrl || (pendingFile ? undefined : null);
          ...
          <SheetHeader className="shrink-0">
            ...
            <SheetDescription>
              {editingOption
                ...
                : "Add a new nominee to this category"}
            </SheetDescription>
          </SheetHeader>
