            ...
            >
              <div
                className={cn(
                  ...
                  {
                    "border-primary-600 bg-primary-600 text-white scale-110 shadow-primary-200":
                      isCurrent,
