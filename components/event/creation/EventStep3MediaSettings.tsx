...
export function EventStep3MediaSettings({
  ...
  const { isUploading: isUploadingBanner, upload: runUploadBanner } =
    useImageUpload({
      bucket: "events",
      folder: "events",
      convertOptions: {
  ...
  const bannerDisplayPreview =
    bannerPreviewUrl || getEventImageUrl(bannerImage);
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          This image will be displayed on your event page (recommended:
          1200x630px)
        </p>
