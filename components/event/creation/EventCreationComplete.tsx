...
export function EventCreationComplete({
  event,
  organizationSlug,
}: EventCreationCompleteProps) {
  ...
  return (
    <div className="flex flex-col items-center text-center py-8">
      ...
      <p className="text-muted-foreground mb-6 max-w-md">
        Your event{" "}
        <span className="font-medium text-foreground">{event.title}</span> has
        been created as a draft. You can now add ticket types, voting
        categories, or publish it when you're ready.
      </p>
