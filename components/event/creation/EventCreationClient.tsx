  ...
  async function createEvent(data: EventFormData) {
    startTransition(async () => {
      ...
      if (data.maxAttendees)
        formDataObj.set("maxAttendees", String(data.maxAttendees));
      formDataObj.set("isPublic", String(data.isPublic ?? true));

      // Add extras
      if (data.sponsors)
        formDataObj.set("sponsors", JSON.stringify(data.sponsors));
      if (data.socialLinks)
        formDataObj.set("socialLinks", JSON.stringify(data.socialLinks));
      if (data.galleryLinks)
        formDataObj.set("galleryLinks", JSON.stringify(data.galleryLinks));
